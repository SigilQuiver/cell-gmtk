...
ALPHABET_CELLPHONE = get_alphabet(pygame.image.load("charmap-cellphone_white.png"))
ALPHABET_FUTURISTIC = get_alphabet(pygame.image.load("charmap-futuristic_black.png"))
ALPHABET_OLDSCHOOL = get_alphabet(pygame.image.load("charmap-oldschool_white.png"))
